      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: "h", text: "Your Bag" },
            { t: "p", html: "As you move through the Biomes you'll collect valuable objects. Your <strong>Bag</strong> is the shared stash where all Gold Teeth, Potions, and Cells go." },
            { t: "h", text: "Biomes" },
...

    {
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            { t: "dl", items: [
              { term: "First Player", def: "When attached to another icon, that effect is only for the First Player (good or bad) and can't be reassigned." },
              { term: "Change First Player", def: "The First Player token passes clockwise — always the first action to take place." },
              { term: "Either / Or", def: "Choose ONE of the listed items. If a choice is a Check, you must be able to pass it to choose it." },
              { term: "Equipment", def: "Take the top Equipment card and give it to a Beheaded to equip." },
              { term: "Blueprints", def: "Take 1 Blueprint from the bottom of the Blueprint deck and place it on the Collector space (available in the Interbiome)." },
              { term: "Gold Tooth", def: "Take 1 Gold Tooth per icon into the Group's Bag." },
              { term: "Scroll", def: "Move 1 Scroll of the indicated colour one space right on 1 player's board." },
              { term: "Vial", def: "Immediately remove 1 Damage token from a Beheaded's Health Track." },
              { term: "Cell", def: "Take 1 Cell per icon into the Group's Bag." },
              { term: "Potion", def: "Take 1 Potion into the Bag. Spend to remove ALL Damage from one Beheaded during Combat Round 0 or instead of a Loot Action." },
              { term: "Rune", def: "Flip the matching Rune card on the Mutation board; its use is on the card and it stays with you forever." },
              { term: "Check", def: "Perform a Check (see Checks)." },
            ] },
          ],
        },
        {
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { t: "dl", items: [
              { term: "Poisoned", def: "Apply 1 Damage per Poisoned token during the Round End Phase of every Combat Round." },
              { term: "Bleeding", def: "Any character still Bleeding after Combat Round III dies." },
              { term: "On Fire", def: "The first On Fire token has no effect; a second On Fire token kills the character immediately." },
              { term: "Frozen", def: "Placed on the character's next Combat line that has an Action; all that round's Actions are skipped by the Frozen character." },
              { term: "Marked", def: "A Marked character suffers +1 to any Damage they receive for the rest of Combat, per token." },
            ] },
